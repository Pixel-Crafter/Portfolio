...
export default function Home() {
  return (
    <main className="w-screen h-screen relative overflow-y-auto no-scrollbar bg-white dark:bg-[#1C1B22] transition-colors duration-300">
      <div className="flex flex-col md:flex-row items-center justify-center w-full h-full bg-cover bg-center">

        {/* LEFT SECTION */}
        <div className="pl-6 pr-6 md:pl-20 md:pr-0 pb-20 md:pb-20 flex flex-col gap-5 z-[10] max-w-[750px] text-center md:text-left">
          <h1 className="text-[32px] sm:text-[42px] md:text-[50px] text-black dark:text-white font-semibold leading-tight">
            Make Anything Possible with
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-green-500">
              {" "}
              Web Development
          ...
          <p className="text-gray-700 dark:text-gray-300 text-sm sm:text-base md:text-lg hidden md:block">
          ...
          <div className="hidden md:flex flex-col md:flex-row gap-5">
            ...
            <Link
              href="/my-projects"
              className="rounded-[20px] group relative bg-transparent border border-black dark:border-white px-5 py-3 text-lg text-black dark:text-white max-w-[200px]"
            >
              <div className="absolute rounded-[20px] bg-black dark:bg-white inset-0 opacity-0 group-hover:opacity-20 transition-opacity" />
              My Projects
            </Link>
        ...
        <div className="w-[80%] sm:w-[60%] md:w-[40%] mx-auto flex flex-col items-center justify-center px-4 md:px-0">
          <h1 className="text-black dark:text-white text-[28px] sm:text-[36px] md:text-[40px] text-center font-bold mb-2">
            Under Development
          </h1>
          <AnimatedProgress />
        </div>
      ...
      {/* MOBILE BUTTONS */}
      <div className="absolute grid grid-cols-2 bottom-10 z-[20] right-0 left-0 md:hidden gap-4 justify-center items-center px-4">
        <Link
          href="/my-skills"
        ...
        <Link
          href="/my-projects"
          className="rounded-[20px] bg-transparent border border-black dark:border-white px-5 py-3 text-base sm:text-lg text-black dark:text-white w-full max-w-[200px] text-center"
        >
          My Projects
        </Link>
        <Link
